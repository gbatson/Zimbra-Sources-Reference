...
<c:if test="${not empty authResult}">
	  ...
	  out.clear();
	  application.getContext("/service").getRequestDispatcher("/extension/sampleoauth/authorization").forward(request, response);
	  %>
</c:if>
                    ...
                    <tr>
                        <td id="ZloginBodyContainer">
                            ...
                            <div id="ZloginFormPanel">
                                <form method="post" name="loginForm" action="/public/authorize.jsp">
