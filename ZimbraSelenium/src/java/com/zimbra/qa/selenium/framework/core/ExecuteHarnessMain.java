...
public class ExecuteHarnessMain {
	...
	public static class ResultListener extends TestListenerAdapter {
		...
		public String getCustomResult() throws HarnessException, FileNotFoundException, IOException {
			...
			resultDirectory = testoutputfoldername
					.replaceAll("[^a-zA-Z0-9/._]", "/")
					.replaceAll("C//opt/qa/main/", "").replaceAll("C//opt/qa/main/ZimbraSelenium/test/output/","")
					.replaceAll("C//opt/qa/JUDASPRIEST/", "").replaceAll("C//opt/qa/JUDASPRIEST/ZimbraSelenium/test/output/", "")
					.replaceAll("C//opt/qa/JUDASPRIEST-860/", "").replaceAll("C//opt/qa/JUDASPRIEST-860/ZimbraSelenium/test/output/", "").replaceAll("860/ZimbraSelenium/test/output/", "");
