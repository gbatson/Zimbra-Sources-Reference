...
public class TestStatusReporter extends TestListenerAdapter {  
   ...
   public TestStatusReporter(Configuration conf, String atype) throws Exception{     
		 output = new java.io.PrintWriter(new FileWriter(new File(conf.getString("ZimbraLogRoot")+"/"+atype+ "/zimbraSelenium-failed.xml")));       
	  }	
  ...
  public void onTestStart(ITestResult tr) { 
	  log("----------------------------- " + tr.getTestClass().getName() + "." +tr.getName() + " started ----------------------------------------");
  }
