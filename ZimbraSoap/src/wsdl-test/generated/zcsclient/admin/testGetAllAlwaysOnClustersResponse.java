...
/**
 * <p>Java class for getAllAlwaysOnClustersResponse complex type.
 * 
...
public class testGetAllAlwaysOnClustersResponse {

    protected List<testAlwaysOnClusterInfo> alwaysOnCluster;
     ...
     * 
     */
    public List<testAlwaysOnClusterInfo> getAlwaysOnCluster() {
        if (alwaysOnCluster == null) {
            alwaysOnCluster = new ArrayList<testAlwaysOnClusterInfo>();
        }
